 ...
 * exploracion-3d donde se usa `v-html`, y solo sobre la salida ya saneada de `renderizarLinea` o
 ...
 *
 * Es una copia deliberada de la de video-texto: cada carpeta de actividad es de un solo dueño y no
 * comparte archivos con las demás (si se unifica, será en una carpeta común).
 */
